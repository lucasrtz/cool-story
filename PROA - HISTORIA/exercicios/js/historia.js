var conteudoA = "<img class='imagem' src='imagens/primeiratela.png' /> <h2>Bom dia dorminhoco!</h2> <p>Você acorda e se depara em um lugar desconhecido e consta que esta com pouca bateria.</p> <p>Você sai em busca de recarregar suas forças, ou prefere dormir mais para poupar energia?</p> <div class= bots> <button class='botao1' onclick='carregarConteudo(conteudoB1)'>Ir dormir</button> <button class='botao1'onclick='carregarConteudo(conteudoB2)'>Uma aventura</button> </div>";
...
var conteudoB2 = "<img class='imagem' src='imagens/segundatela222.png' />  <h2>Então você quer uma aventura?</h2> <p>Okay bonitão, gostei da atitude de ir em busca do que precisa.</p> <p>Agora tem duas opções, você vai se manter na cidade ou seguir para a floresta?</p> <div class= bots> <button class='botao1' onclick='carregarConteudo(conteudoC1)'>Continuar na cidade</button> <button class='botao1' onclick='carregarConteudo(conteudoC2)'>Ir para a floresta</button> </div>";

var conteudoC1 = "<img class='imagem' src='imagens/segundatela.png' />  <h2>Two strange Noia in a moto appears!</h2> <p>Durante uma jornada intempéries podem surgir, ou neste caso, dois caras em uma moto.</p> <p>Você decide reagir ao assalto?</p> <div class= bots> <button class='botao1' onclick='carregarConteudo(conteudoD1)'>Irei reagir</button> <button class='botao1' onclick='carregarConteudo(conteudoD2)'>Não irei reagir</button> </div>";

var conteudoC2 = "<img class='imagem' src='imagens/robofloresta.png' /> <h2>Um jornada pela grande floresta... De Osasco.</h2> <p>O robô se levanta e segue seu caminho em direção em uma grande floresta.</p> <div class= bots> <button class='botao1' onclick='carregarConteudo(conteudoD3)'>Continuar</button> </div>"

var conteudoD1 = "<img class='imagem' src='imagens/terceiratela.png' />  <h2>Parabéns pela coragem, porque senso...</h2> <p>Você decide enfrentar os noias com o seu ULTRA CANÃO DE PLASMA SUPERFREACKINGBLASTERMEGAPOWEROBLITERATORNATOR (pilhas não inclusas).</p> <div class= bots> <button class='botao1' onclick='carregarConteudo(conteudoE1)'>Continuar</button> </div>";
...
var conteudoD3 = "<img class='imagem' src='imagens/robocomcrianca.png' /> <h2>Se aproxima um garoto.</h2> <p>Ao adentra-la, encontra um garoto.</p> <p>Bater no garoto?</p> <a href='https://www.camara.leg.br/noticias/774074-projeto-cria-lei-henry-para-coibir-violencia-contra-criancas-e-adolescentes/#:~:text=O%20Projeto%20de%20Lei%201360,e%20dano%20moral%20ou%20patrimonial'> <div class= bots> <button class='botao1'> Sim</button></a> <button class='botao1' onclick='carregarConteudo(conteudoE2)'>Não</button> </div>";

var conteudoE1 = "<img class='imagem' src='imagens/quartatela.gif' /> <h2>E o obvio acontece.</h2> <p>Eles fogem</p> <div class= bots> <button class='botao1' onclick='carregarConteudo(conteudoF1)'>Continuar</button> </div>";

var conteudoE2 = "<img class='imagem' src='imagens/robocriancagatinho.png' /> <h2>A busca por Patrício.</h2> <p>- Oi tio, eu me chamo Denilton, você pode me ajudar a encontrar o meu gato? - Pergunta o garoto.</p> <div class= bots> <button class='botao1' onclick='carregarConteudo(conteudoF2)'>Sim</button> <button class='botao1' onclick='carregarConteudo(conteudoF3)'>Não</button> </div>";
  
var conteudoF1 = "<img class='imagem' src='imagens/quintatela.gif' /> <h2>IH SERJÃO SUJOU!!!!!!</h2> <p>Os tiras viram a treta toda e chegaram pra te prender, você vai tentar fugir?</p> <div class= bots> <button class='botao1' onclick='carregarConteudo(conteudoG1)'>Sim</button> <button class='botao1' onclick='carregarConteudo(conteudoG2)'>Não</button> </div>";

var conteudoF2 = "<img class='imagem' src='imagens/aliendaogato.png' /> <h2>Uma proposta um tanto quanto estranha.</h2> <p>Você e o garoto Denilton adentram a floresta em busca do gato.</p> <p>Após minutos de procura vocês encontram o gato com um ET.</p> <p>O ET após devolver patrício (o gato do Denilton)  lhe oferece a chance de encontrar algo valioso:</p> <p>-Aqui eu te dou a oportunidade de descobrir o maior segredo do universo, se aceitar pegue essa bateria moura e esse mapa, eles te manterão funcionando e te guiarão para seu destino, se não quiser vai a merda</p> <p>Você quer ir em busca do tesouro?</p> <div class= bots><button class='botao1' onclick='carregarConteudo(conteudoG3)'>Mané tesouro</button> <button class='botao1' onclick='carregarConteudo(conteudoG4)'>Ir em busca do tesouro</button></div>";

var conteudoF3 = "<img class='imagem' src='imagens/robocriancagatinho.png' /> <h2>QUE TIPO DE MONSTRO VOCÊ É?</h2> <div class= bots><button class='botao1' onclick='carregarConteudo(conteudoE2)'>Voltar</button></div>";
...
var conteudoG2 = "<img class='imagem' src='imagens/policia.png' /> <h2>Enquadrado!</h2> <p>Você rouba a bateria da viatura para conseguir mais energia?</p> <div class= bots><button class='botao1' onclick='carregarConteudo(conteudoH1)'>Sim</button> <button class='botao1' onclick='carregarConteudo(conteudoH2)'>Não</button></div>";
...
var conteudoG4 = "<img class='imagem' src='imagens/robonacaverna.png' /> <h2>Em busca da caixa de Pandora</h2> <p>Você aceita a oferta do ET e usa o mapa para adentrar a floresta em busca da caixa de Pandora , pois nela esta o maior tesouro do universo, a coisa que pode acabar com qualquer guerra, pode curar qualquer chaga, pode torar qualquer um feliz novamente, um poder imensurável capaz do inimaginável e incompreensível.</p> <div class= bots><button class='botao1' onclick='carregarConteudo(conteudoH3)'>Continuar</button></div>";

var conteudoH1 = "<img class='imagem' src='imagens/oitavatela.png' /> <h2>Apologia ao crime!</h2> <p>Como um criminoso sem controle você rouba a bateria da viatura, restaurando sua energia.</p> <div class= bots><button class='botao1' onclick='carregarConteudo(conteudoI1)'>Continuar</button></div>";
